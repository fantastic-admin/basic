...
<template>
  <div>
    <Alert />
    <FaPageHeader title="Animate.css">
      <template #description>
        <Command text="pnpm add animate.css" />
      </template>
      <FaButton variant="outline" size="icon" @click="open('https://github.com/animate-css/animate.css')">
    ...
    <FaPageMain>
      <div class="space-y-2">
        <div class="flex gap-2 items-center">
          进入动画
          <FaSelect v-model="animateIn" :options="animateList" />
        </div>
        <div class="flex gap-2 items-center">
          退出动画
          <FaSelect v-model="animateOut" :options="animateList" />
        </div>
